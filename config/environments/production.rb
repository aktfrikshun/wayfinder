...
Rails.application.configure do
  ...
  # Store uploaded files in S3-compatible storage by default; allow override via ACTIVE_STORAGE_SERVICE for flexibility.
  ...
  # Lean mode: use in-process cache to reduce DB load and infra costs.
  config.cache_store = :memory_store

  # Lean mode: run jobs in-process to avoid a dedicated worker machine.
